...
exports.default = util.createRule({
    ...
    create(context) {
        ...
        function isSpaceChar(token) {
            return (token.type === utils_1.AST_TOKEN_TYPES.Punctuator &&
                /^[=|?|:]$/.test(token.value));
        }
        ...
        function checkForTypeConditional(node) {
            const extendsTypeNode = sourceCode.getTokenByRangeStart(node.extendsType.range[0]);
            const trueTypeNode = sourceCode.getTokenByRangeStart(node.trueType.range[0]);
            const falseTypeNode = sourceCode.getTokenByRangeStart(node.falseType.range[0]);
